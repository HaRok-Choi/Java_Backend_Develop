package chapter04.A_Modifier;

import chapter04.A_AccessModifier.Example4;

// 제어자
// 클래스, 변수 or 메서드의 선언부에서 사용되는 부가적 의미를 추가해주는 키워드

// 접근 제어자: public, protect, default, private
// 기타 제어자: static, abstract, final

// 하나의 대상에 여러개의 제어자를 종합해서 사용할 수 있음
// 단, 접근 제어자는 한 선언에 대하야 한번만 사용할 수 있음
// 제어자의 순서는 무관
...
//	메서드 선언문에 abstract가 포함되어 있으면 해당 메서드는 구현되지 않았음을 의미
	abstract void function3();	// 구현부가 없다
}
