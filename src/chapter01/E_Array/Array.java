...
// 배열
// '같은 타입'의 변수가 나열된 형태
// 배열은 '생성'해서 사용 함 => 생성해서 사용하는 변수: 참조 변수(★★실제 주소가 들어가있음!!!)
// new 연산자로 생성 할 수 있음
// 배열은 실제 데이터가 저장되는 것이 아니라 데이터 배열이 저장된 첫 번째 메모리 주소가 저장됨
// ★인덱스는 경계에 있는 값을 기준으로 함
...
//		같은 메모리 주소이기 때문에 extra의 값을 변경해도 score에서 값도 바뀌는것
